<?php
/**
 * Template part for displaying page content in archive-demands.php
 *
    ...
    <article class="lp-card lp-card-offer">
        <header class="lp-card__header">
            ...
            <div class="lp-card__media">
                ...
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/card-placeholder.jpg" alt="profile demand card" class="lp-card__img" />
                <? endif; ?>
            </div>
        ...
        <div class="lp-card__body">
            ...
            <div class="lp-card-offer__skills">
                <?
                    $demand_skills = (array) get_post_meta( get_the_ID(), 'skills', true );
                ?>
                <div class="lp-typo lp-sub lp-grey"><?= implode(', ', $demand_skills); ?></div>
