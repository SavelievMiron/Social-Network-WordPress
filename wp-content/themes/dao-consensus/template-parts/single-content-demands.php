<?php
/**
 * Template part for displaying page content in single-demands.php
 *
                    ...
                    <div class="lp-flex lp-align-center lp-justify-between">
                        ...
                        <?
                           if ( is_user_logged_in() && ( get_current_user_id() != $post->post_author ) ):
                                if ( get_post_status( $post->ID ) !== 'in-process' ) :
                        ?>
                        ...
                        <?      else :  ?>
                                    ...
                                    <button class="lp-button-base lp-button lp-size-medium lp-theme-default lp-variant-filled" disabled>
                                        В работе
                                    </button>
                        <?
                                endif;
                    ...
                    <div class="lp-common-info__stats">
                        <ul class="lp-list lp-no-style">
                            ...
                            <!-- <li>
                                ...
                                <span class="lp-typo lp-footnote lp-grey"> повторных заказов </span>
                            </li> -->
                        </ul>
                    </div>
                    <hr class="lp-divider" />
                    ...
                    <div class="lp-grid lp-container lp-spacing-3">
                        ...
                        <div class="lp-grid lp-item lp-xs-12">
                            <div class="lp-skills__chips lp-flex lp-wrap">
                                ...
                                if( ! empty( $demand_skills ) ):
                                    foreach( $demand_skills as $skill ): ?>
