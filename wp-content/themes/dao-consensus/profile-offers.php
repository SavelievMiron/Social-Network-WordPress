					...
					<div id="tabs" class="lp-grid lp-container lp-spacing-3" data-lp-tabs>
							...
							<div class="lp-grid lp-container lp-spacing-2 lp-align-center">
								<div class="lp-grid lp-item lp-lg-8 lp-md-7 lp-sm-6 lp-xs-12">
									<div class="lp-tabs" data-lp-tabs="tabs">
										<button class="lp-button-base lp-button-tab lp-selected" data-lp-selected="true">Мои предложения</button>
									</div>
								</div>

								<div class="lp-grid lp-item lp-lg-4 lp-md-5 lp-sm-6 lp-xs-12">
									<a href="<?php echo get_permalink( 19 ) . '?type=offer'; ?>" class="lp-button-base lp-button lp-size-large lp-theme-primary lp-variant-outlined lp-full">
						...
						<?  else: ?>
								<div class="no-results not-found">
									<p>
										<? _e('Вы ещё не опубликовали ни одного предложения.', 'dao-consensus'); ?>
									</p>
								</div>
						<?
							endif;
